...
var favoriteplaces = ["korea", "china", "turkey", "england", "france"];
//• Print your array in its original order.
console.log("ooriginal order", favoriteplaces);
console.log(`...............`);
//• Print your array in alphabetical order without modifying the actual list.
var alphabeticalorder = favoriteplaces;
...
var fourlines = [`"Quaid-e-Azam Leader of is our the greatest history.",
...
//these items.
var rivers = ["indus river", "jhelum ", "kabul", "chenab"];
...
var favorite_fruits = ["orange", "grapes", "mango"];
...
function make_shirt(size = 25, textprint = "I LOVE MY LIFE") {
    function make_shirt(size, textprint) {
...
function make_album(artist_name, album_title, optional_parameter) {
    let Object = {
        artist_name,
        album_title,
        optional_parameter
...
//assignment 24
function show_magicians1(showmagicians1) {
    showmagicians1.map((element) => {
        console.log("the great magician ", element, "is the popular in world");
    });
}
...
//assignment 
function car(munfacture, colour, model, inventedyear) {
    let Object = {
        munfacture,
        model,
        colour,
...
var pizza = ["pepronic pizza", "greek pizza", "vegetarian pizza"];
...
let current_users = ["ali", "hassan", "shakeela", "zainab"];
let new_users1 = ["ali", "hassan", "shakeela", "malaika", "zainab"];
for (let index = 0; index < current_users.length; index++) {
    new_users1.map((element) => {
